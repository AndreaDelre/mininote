...
- [ ] Faire des proposition théoriques pour gérer la visualisation des notes en format markdown. Cette interpreteur markdown doit faire comme notion, obsidian et autres app qui permettent de faire du markdown "avancé" (tableaux, to do liste, titres, images, liens, etc).
